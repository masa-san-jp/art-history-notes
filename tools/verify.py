...
def steps() -> list[list[str]]:
    ...
    return [
        ...
        [python, "tools/audit_source_migration.py", "--check-type", "work", "--quiet"],
        [python, "tools/audit_source_migration.py", "--check-type", "place", "--quiet"],
        [python, "tools/audit_source_migration.py", "--check-type", "event", "--quiet"],
        [python, "tools/audit_source_migration.py", "--check-type", "org", "--quiet"],
        [python, "tools/audit_source_migration.py", "--check-type", "concept", "--quiet"],
        [python, "tools/audit_source_migration.py", "--check-type", "source", "--quiet"],
