...
公式カタログである。索引と本文の対応から、現時点で次の27作家63件を作品エンティティとして個別化している。
...
したがって、1891年展については公式カタログの存在、刊行情報、上記27作家の掲載番号と作品名を個別記録済みである。
カランドラの3件とブッティの1件は彫刻の出品記録として扱い、両者をイタリア分割主義の構成員とは推定しない。
