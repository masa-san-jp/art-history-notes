---
id: event/salon-divisionnistes-italiens-paris-1907
uri: urn:ahn:event/salon-divisionnistes-italiens-paris-1907
type: event
label_ja: パリ・イタリア分割主義者展
label_en: Salon des Peintres Divisionnistes Italiens
authority:
  wikidata: null
  aat: null
  ndl: null
...
現行データでは、絵画・素描177件をカタログ番号付きの作品エンティティとして個別化している。残る113件は、
版画・彫刻・工芸品など「その他の媒体」に分類される項目で、個別典拠との照合を継続する。

DoMEの「その他の媒体」113件は、Salle Bのカタログ番号58〜92の35件と、Salle Cの147〜224の78件に分かれる。DoME上ではこれらの項目の作家名・題名・具体的な媒体が空欄のまま登録されているため、番号だけでは個別作品を同定できない。なお、101〜103番はDoMEが「entriesなし」とする欠番であり、113件には含まれない。

一次カタログ本文の展示記述では、リベロ・アンドレオッティの小像・メダル・プラーク約50点が展示室Bを占め、
展示室Cには[`カルロ・ブガッティ`](../persons/carlo-bugatti.md)の家具と[`レンブラント・ブガッティ`](../persons/rembrandt-bugatti.md)の彫刻が置かれていた。また、同室の回廊には
セガンティーニ親子のエッチングと素描、[`エウジェニオ・ベッロージオ`](../persons/eugenio-bellosio.md)の鉄製工芸品、ピエトロ・マルナーティの金工品、
[`パオロ・トルベツコイ`](../persons/paolo-troubetzkoy.md)によるジョヴァンニ・セガンティーニ胸像が記録されている。これらは展示状況を示す本文記述で、
個別のカタログ番号・作品同定が揃っていないため、現行の177件および残る113件の項目対応にはまだ加えていない。
