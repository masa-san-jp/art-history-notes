...
**文化圏を跨ぐ関係が無い**
- 他の文化圏の movement と1本も繋がっていない movement が 42/99 件。時間だけでなく空間の広がりを体系化するので、影響・伝播・反発を調べる余地
- europe-west: 9件（ダダ、デ・ステイル、フォーヴィスム、ゴシック美術 ほか）
...
- americas-latin: 2件（マディ、インディヘニスモ）
