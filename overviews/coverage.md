...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| europe-west（西欧・南欧・北欧） |  |  |  |  |  | 1 | 1 | 1 | 1 | 1 |  | 2 | 8 | 9 |  | 24 |
...
**文化圏を跨ぐ関係が無い**
- 他の文化圏の movement と1本も繋がっていない movement が 22/101 件。時間だけでなく空間の広がりを体系化するので、影響・伝播・反発を調べる余地
...
- europe-west: 3件（フォーヴィスム、新印象派、象徴主義）
...
5. **分割主義・イタリア分割主義**。まず技法・原理として `concept/divisionism` を追加した。
   フランスの新印象派とイタリアの Divisionismo を同一の movement にまとめず、地域差を調べてから
   必要なら別の movement として立てる。
